                         ...
                         GnomeVFSACLPerm *perms)
{
	...
	permset_set (&priv->perm_set, perms);	
}
			  ...
			  GnomeVFSACE     *dest)
{
	...
	priv_source = GET_PRIVATE (source);
	priv_dest = GET_PRIVATE (dest);
                     ...
                     GnomeVFSACE     *entry_b)
{
	...
	priv_a = GET_PRIVATE (entry_a);
	priv_b = GET_PRIVATE (entry_b);
